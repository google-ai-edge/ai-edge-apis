...
/** Formats requests and parses responses for Gemma. */
public final class GemmaFormatter implements ModelFormatter {
  ...
  static {
    System.loadLibrary("jni_gemma_formatter_android");
  }

  public GemmaFormatter() {
    this(ModelFormatterOptions.builder().build());
  }

  public GemmaFormatter(ModelFormatterOptions formatterOptions) {
    this.formatterOptions = formatterOptions;
    this.formatterOptionsProto = formatterOptions.toProto();
  }

  /**
   * Formats a system message and a list of tools into a string for Gemma.
   *
  ...
  /** Formats a {@link Content} into a string for Gemma. */
  @Override
  ...
  /** Formats a {@link GenerateContentRequest} into a prompt for Gemma. */
  @Override
  ...
  /**
   * Parses a Gemma response into a {@link GenerateContentResponse}.
   *
